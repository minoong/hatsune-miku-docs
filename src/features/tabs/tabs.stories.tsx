    ...
    <div className="w-96">
      <Tab.Root defaultValue="tab1">
        <Tab.List aria-label="메인 탭" className="flex border-b border-gray-200 bg-gray-50 rounded-t-lg">
          <Tab.Trigger
            value="tab1"
            className="flex-1 px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 data-[state=active]:text-blue-600 data-[state=active]:bg-white data-[state=active]:border-b-2 data-[state=active]:border-blue-600 transition-colors"
          >
            탭 1
          </Tab.Trigger>
          <Tab.Trigger
      ...
      <div className="w-96">
        ...
        <Tab.Root value={activeTab} onValueChange={setActiveTab}>
          <Tab.List aria-label="계정 설정" className="flex bg-gray-100 rounded-lg p-1">
            <Tab.Trigger
              value="profile"
              className="flex-1 px-3 py-2 text-sm font-medium rounded-md text-gray-700 data-[state=active]:bg-white data-[state=active]:text-gray-900 data-[state=active]:shadow-sm transition-all"
            >
              프로필
            </Tab.Trigger>
            <Tab.Trigger
    ...
    <div className="w-96">
      <Tab.Root defaultValue="available1">
        <Tab.List aria-label="기능 탭" className="flex border-b border-gray-200">
          <Tab.Trigger
            value="available1"
            className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 data-[state=active]:text-blue-600 data-[state=active]:border-b-2 data-[state=active]:border-blue-600 transition-colors"
          >
            사용 가능
          </Tab.Trigger>
    ...
    <div className="flex w-96 h-64">
      <Tab.Root defaultValue="overview">
        <Tab.List aria-label="세로 탭" className="flex flex-col w-32 border-r border-gray-200 pr-2">
          <Tab.Trigger
            value="overview"
            className="mb-1 px-3 py-2 text-sm text-left rounded-md text-gray-700 hover:bg-gray-100 data-[state=active]:bg-blue-100 data-[state=active]:text-blue-700 transition-colors"
          >
            개요
          </Tab.Trigger>
          <Tab.Trigger
    ...
    <div className="w-96">
      <Tab.Root defaultValue="tab1">
        <Tab.List aria-label="강제 마운트 예시" className="flex border-b border-gray-200">
          <Tab.Trigger
            value="tab1"
            className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 data-[state=active]:text-blue-600 data-[state=active]:border-b-2 data-[state=active]:border-blue-600"
          >
            일반 탭
          </Tab.Trigger>
          <Tab.Trigger
