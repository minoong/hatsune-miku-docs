  ...
  render: () => (
    <FlipCard>
      ...
      <FlipCard.Content className="bg-slate-800">
        <div className="translate-z-24 rounded-lg bg-gradient-to-br from-pink-500 to-yellow-400 p-5">
      ...
      <FlipCard.Grid>
        {Array.from({ length: 6 }, (_, i) => (
          <FlipCard key={i}>
            <FlipCard.Image src="./images/miku-main.png" alt="Miku" />
            <FlipCard.Content className="bg-slate-800">
              <div className="rounded-lg bg-gradient-to-br from-pink-500 to-yellow-400 p-5">
  ...
  render: () => (
    <FlipCard>
      ...
      <FlipCard.Content className="bg-gradient-to-br from-blue-500 to-purple-600">
        <div className="p-5">
          <FlipCard.Title className="mb-4 text-2xl font-bold">🎨 나만의 스타일</FlipCard.Title>
  ...
  render: () => (
    <div className="flex flex-wrap justify-center gap-8">
      <FlipCard>
        ...
        <FlipCard.Content className="bg-slate-800">
          <div className="rounded-lg bg-gradient-to-br from-green-500 to-blue-500 p-5">
      ...
      <FlipCard>
        ...
        <FlipCard.Content className="bg-slate-800">
          <div className="rounded-lg bg-gradient-to-br from-purple-500 to-pink-500 p-5">
